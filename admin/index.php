        ...
        switch ($act) {
            ...
            $listdanhmuc = load_all_danhmuc();
                ...
                case "adddm":
                    ...
                    if(isset($_POST['themmoi']) && $_POST['themmoi']){
                        ...
                        } else if (!preg_match('/^[a-zA-Z0-9_ÀÁÂÃĐÈÉÊẾÌÍÒÓÔÕỒỜỌÙÚỦỤÝàáâãđèéêếìíòóôõồờọùúủụý\s]+$/u', $tendanhmuc)) {
            ...
            case 'suadm':
                if(isset($_POST['capnhat']) && $_POST['capnhat']){
                    ...
                    if (!preg_match('/^[a-zA-Z0-9_ÀÁÂÃĐÈÉÊẾÌÍÒÓÔÕỒỜỌÙÚỦỤÝàáâãđèéêếìíòóôõồờọùúủụý\s]+$/u', $tendanhmuc)) {
                        $thongbao = "Tên danh mục không được chứa ký tự đặc biệt";
                    }
            ...
            case 'addsp':
                if(isset($_POST['themmoi']) && $_POST['themmoi']){
                    ...
                    if (kiemtra_sanpham($tensanpham,$iddanhmuc)) {
                     ...
                     else if (!preg_match('/^[a-zA-Z0-9_ÀÁÂÃĐÈÉÊẾÌÍÒÓÔÕỒỜỌÙÚỦỤÝàáâãđèéêếìíòóôõồờọùúủụý\s]+$/u', $tensanpham)) {
