...
<div class="tieude">
    ...
    <form class="form" enctype="multipart/form-data" method="post" action="index.php?act=addctsp">
        <div class="chondanhmuc">
            ...
            <input type="text" class="tendanhmuc" name="tensanpham" value="<?php echo $sanpham['name'] ?>" >
            ...
            <button class="ratranglist"><a href="index.php?act=chitietsp&id_sp=<?php echo $sanpham['id'] ?>">Quay lại trang chi tiết sản phẩm</a></button>
