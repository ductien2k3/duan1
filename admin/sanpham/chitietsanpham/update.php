...
<div class="tieude">
    ...
    <form class="form" enctype="multipart/form-data" method="post" action="index.php?act=updatectsp">
        <div class="chondanhmuc">
            ...
            <input type="text" min="0" class="tendanhmuc" name="soluong" value="<?=$so_luong?>" required placeholder="Nhập vào số lượng">
